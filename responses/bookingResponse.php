...
function getday($username, $phonenumber) {
    $payload = [
        "username" => $username,
        "mobilenumber" => $phonenumber,
        "type" => "1",
...
function getClinic($username, $phonenumber,$dateid) {
    $payload = [
        "username" => $username,
        "mobilenumber" => $phonenumber,
        "type" => "1",
...
function getslots($username, $phonenumber, $dateid, $clinicid) {
    $payload = [
        "username" => $username,
        "mobilenumber" => $phonenumber,
        "type" => "1",
...
function dobooking($name, $phone, $dateid, $clinicid, $slotName, $slotTime, $patientname) {
    $payload = [
        "username" => $name,
        "mobilenumber" => $phone,
        "type" => "1",
